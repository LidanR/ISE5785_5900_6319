...
class SphereTests {
    ...
    void testFindIntersections() {
        ...
        assertEquals(s.findIntersections(new Ray(new Point(0, 1, 0), new Vector(1, 0, 0))).size(), 1, "Ray start inside the sphere and intersects the sphere");
        // TC02: Ray start outside the sphere and intersects the sphere
        assertEquals(s.findIntersections(new Ray(new Point(1, 3, 0), new Vector(0, -1, 0))).size(), 2, "Ray start outside the sphere and intersects the sphere");
        ...
        assertEquals(s.findIntersections(new Ray(new Point(0, 0, 0), new Vector(1, 0, 0))).size(), 1, "Ray start on the sphere center and intersects the sphere once");
        // TC06: Ray start on the sphere and passes through the sphere's center
        assertEquals(s.findIntersections(new Ray(new Point(0, 2, 0), new Vector(0, -1, 0))).size(), 1, "Ray start on the sphere and passes through the sphere's center");
        // TC07: Ray start before the sphere and passes through the sphere's center
        assertEquals(s.findIntersections(new Ray(new Point(0, 4, 0), new Vector(0, -1, 0))).size(), 2, "Ray start before the sphere and passes through the sphere's center");
        ...
        assertEquals(s.findIntersections(new Ray(new Point(0, 1, 0), new Vector(0, 1, 0))).size(),1, "Ray start inside the sphere and the other direction intersects the sphere's center");


        // TC11: Ray start on the sphere and doesn't pass through the sphere's center but intersects the sphere once
        assertEquals(s.findIntersections(new Ray(new Point(0, 2, 0), new Vector(1, -0.5, 0))).size(), 1, "Ray start on the sphere and doesn't pass through the sphere's center but intersects the sphere once");
        ...
        // TC13: Ray start onthr sphere and doesn't intersect with the sphere at all
        ...
        assertEquals(s.findIntersections(new Ray(new Point(0, 1, 0), new Vector(0, 0, 1))).size(), 1, "Ray start inside the sphere and orthogonal to the sphere's center if we draw a line from the sphere's center to the ray's start point");
